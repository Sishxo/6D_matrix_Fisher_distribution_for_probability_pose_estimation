...
class ModelNetSo3():
    ...
    def get_train(self):
        full = ModelNetSo3Subset(os.path.join(self.modelnet_dir, train_name), category = self.category) # split TODO
        return full
...
class ModelNetSo3Subset():
    def __init__(self, path, imsize=224, category=None):
        ...
        print("modelnet subset length: "+str(len(self.keys))+" category: "+str(category))
